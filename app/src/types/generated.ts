...
//   const agentInboxBatchResult = Convert.toAgentInboxBatchResult(json);
//   const agentInboxItem = Convert.toAgentInboxItem(json);
//   const agentInboxMessage = Convert.toAgentInboxMessage(json);
//   const agentMessageState = Convert.toAgentMessageState(json);
...
//   const agentMsgStatusMessage = Convert.toAgentMsgStatusMessage(json);
//   const agentPeekExit = Convert.toAgentPeekExit(json);
...
//   const agentPeerMessage = Convert.toAgentPeerMessage(json);
...
//   const gardenReview = Convert.toGardenReview(json);
//   const gardenReviewEvidence = Convert.toGardenReviewEvidence(json);
//   const gardenReviewItem = Convert.toGardenReviewItem(json);
//   const gardenReviewRecipe = Convert.toGardenReviewRecipe(json);
...
//   const pullRequestCreatedMessage = Convert.toPullRequestCreatedMessage(json);
//   const pullRequestForgetMessage = Convert.toPullRequestForgetMessage(json);
...
//   const seedHarvestCondition = Convert.toSeedHarvestCondition(json);
//   const seedHarvestWhenMerged = Convert.toSeedHarvestWhenMerged(json);
...
//   const seedReviewActionContext = Convert.toSeedReviewActionContext(json);
//   const seedReviewCancelMessage = Convert.toSeedReviewCancelMessage(json);
//   const seedReviewDraftMessage = Convert.toSeedReviewDraftMessage(json);
//   const seedReviewDraftResultMessage = Convert.toSeedReviewDraftResultMessage(json);
//   const seedReviewKeepMessage = Convert.toSeedReviewKeepMessage(json);
//   const seedReviewResult = Convert.toSeedReviewResult(json);
//   const seedReviewResultMessage = Convert.toSeedReviewResultMessage(json);
//   const seedReviewRetryMessage = Convert.toSeedReviewRetryMessage(json);
//   const seedReviewShowMessage = Convert.toSeedReviewShowMessage(json);
//   const seedReviewStartMessage = Convert.toSeedReviewStartMessage(json);
...
//   const stopBackgroundTask = Convert.toStopBackgroundTask(json);
...
export interface AgentInboxBatchResult {
    items:     ItemElement[];
    remaining: number;
    [property: string]: any;
}
...
export enum AgentInboxMessageCmd {
...
export interface AgentMsgStatusMessage {
    cmd:               AgentMsgStatusMessageCmd;
    message_id:        string;
    sender_session_id: string;
    [property: string]: any;
}

export enum AgentMsgStatusMessageCmd {
    AgentMsgStatus = "agent_msg_status",
}

export interface AgentPeekExit {
    at:      string;
    code:    number;
    signal?: string;
    [property: string]: any;
...
export interface ModelObject {
    ...
    cache_write_unclassified_tokens: number;
    cost_usd?:                       number;
    has_unpriced_usage:              boolean;
    input_tokens:                    number;
    model:                           string;
...
export interface ItemObject {
    actions:               string[];
    advisor_attempt?:      number;
    advisor_error?:        string;
    advisor_max_attempts?: number;
...
export interface GardenReviewEvidence {
    label: string;
    text:  string;
    [property: string]: any;
}

export interface GardenReviewItem {
    actions:               string[];
    advisor_attempt?:      number;
    advisor_error?:        string;
    advisor_max_attempts?: number;
...
export interface GardenReviewRecipe {
    agent:   string;
    effort?: string;
    model:   string;
    [property: string]: any;
...
export interface GardenReviewRun {
    candidate_ids: string[];
    captured_at:   string;
    completed_at?: string;
    id:            string;
...
export interface GardenReviewUpdatedMessage {
    event:  GardenReviewUpdatedMessageEvent;
    review: GardenReviewUpdatedMessageReview;
    [property: string]: any;
}

export enum GardenReviewUpdatedMessageEvent {
    GardenReviewUpdated = "garden_review_updated",
}
...
export enum PullRequestCreatedMessageCmd {
    PullRequestCreated = "pull_request_created",
}

export interface PullRequestForgetMessage {
    cmd: PullRequestForgetMessageCmd;
    id:  string;
    url: string;
    [property: string]: any;
}

export enum PullRequestForgetMessageCmd {
    PullRequestForget = "pull_request_forget",
}
...
export interface AgentInboxBatchResultObject {
    items:     ItemElement[];
    remaining: number;
    [property: string]: any;
}
...
export interface SeedReviewResultObject {
...
export interface SessionListResultObject {
    entries:      Entry[];
    facets?:      Facets;
    next_before?: string;
    omitted:      number;
...
export interface SessionShowResultObject {
    entry: Entry;
    [property: string]: any;
}
...
export interface SeedHarvestWhenMerged {
...
export enum SeedReviewCancelMessageCmd {
    SeedReviewCancel = "seed_review_cancel",
}
...
export enum SeedReviewDraftMessageCmd {
    SeedReviewDraft = "seed_review_draft",
}

export interface SeedReviewDraftResultMessage {
    error?:     string;
    event:      SeedReviewDraftResultMessageEvent;
    handoff?:   string;
    request_id: string;
    success:    boolean;
    [property: string]: any;
...
export enum SeedReviewDraftResultMessageEvent {
    SeedReviewDraftResult = "seed_review_draft_result",
}
...
export enum SeedReviewKeepMessageCmd {
    SeedReviewKeep = "seed_review_keep",
}
...
export interface SeedReviewResultMessage {
    candidate_count: number;
    error?:          string;
...
export enum SeedReviewResultMessageEvent {
    SeedReviewResult = "seed_review_result",
}
...
export enum SeedReviewRetryMessageCmd {
    SeedReviewRetry = "seed_review_retry",
}
...
export enum SeedReviewShowMessageCmd {
    SeedReviewShow = "seed_review_show",
}
...
export enum SeedReviewStartMessageCmd {
    SeedReviewStart = "seed_review_start",
}
...
export enum SeedSendToChiefMessageCmd {
    SeedSendToChief = "seed_send_to_chief",
}
...
export interface SeedSendToChiefResultMessage {
    error?:     string;
    event:      SeedSendToChiefResultMessageEvent;
    request_id: string;
    result?:    SeedSendToChiefResultObject;
    success:    boolean;
    [property: string]: any;
}
...
export enum SessionClosedMessageEvent {
...
export interface SessionLedgerFacet {
    count: number;
    value: string;
    [property: string]: any;
}
...
export enum SessionListMessageCmd {
...
export interface SessionListResultMessage {
    error?:     string;
    event:      SessionListResultMessageEvent;
    request_id: string;
    result?:    SessionListResultObject;
    success:    boolean;
    [property: string]: any;
}

export enum SessionListResultMessageEvent {
...
export interface SessionShowMessage {
    cmd:         SessionShowMessageCmd;
    request_id?: string;
    session_id:  string;
    [property: string]: any;
}

export enum SessionShowMessageCmd {
...
export interface SessionShowResultMessage {
    entry?:     Entry;
    error?:     string;
    event:      SessionShowResultMessageEvent;
    request_id: string;
    success:    boolean;
    [property: string]: any;
}

export enum SessionShowResultMessageEvent {
    SessionShowResult = "session_show_result",
}
...
export interface StopBackgroundTask {
    name?:  string;
    status: string;
    type:   string;
    [property: string]: any;
...
export interface StopMessage {
    background_tasks?:      BackgroundTaskElement[];
    cmd:                    StopMessageCmd;
    id:                     string;
...
export interface BackgroundTaskElement {
    name?:  string;
    status: string;
    type:   string;
    [property: string]: any;
...
export class Convert {
    ...
    public static toAgentInboxBatchResult(json: string): AgentInboxBatchResult {
        return cast(JSON.parse(json), r("AgentInboxBatchResult"));
    }

    public static agentInboxBatchResultToJson(value: AgentInboxBatchResult): string {
        return JSON.stringify(uncast(value, r("AgentInboxBatchResult")), null, 2);
    }

    public static toAgentInboxItem(json: string): AgentInboxItem {
        return cast(JSON.parse(json), r("AgentInboxItem"));
    }

    public static agentInboxItemToJson(value: AgentInboxItem): string {
        return JSON.stringify(uncast(value, r("AgentInboxItem")), null, 2);
    }

    public static toAgentInboxMessage(json: string): AgentInboxMessage {
        return cast(JSON.parse(json), r("AgentInboxMessage"));
    }

    public static agentInboxMessageToJson(value: AgentInboxMessage): string {
        return JSON.stringify(uncast(value, r("AgentInboxMessage")), null, 2);
    }

    public static toAgentMessageState(json: string): AgentMessageState {
        return cast(JSON.parse(json), r("AgentMessageState"));
    }

    public static agentMessageStateToJson(value: AgentMessageState): string {
        return JSON.stringify(uncast(value, r("AgentMessageState")), null, 2);
    }
    ...
    public static toAgentMsgStatusMessage(json: string): AgentMsgStatusMessage {
        return cast(JSON.parse(json), r("AgentMsgStatusMessage"));
    }

    public static agentMsgStatusMessageToJson(value: AgentMsgStatusMessage): string {
        return JSON.stringify(uncast(value, r("AgentMsgStatusMessage")), null, 2);
    }

    public static toAgentPeekExit(json: string): AgentPeekExit {
        return cast(JSON.parse(json), r("AgentPeekExit"));
    }

    public static agentPeekExitToJson(value: AgentPeekExit): string {
        return JSON.stringify(uncast(value, r("AgentPeekExit")), null, 2);
    }
    ...
    public static toAgentPeerMessage(json: string): AgentPeerMessage {
        return cast(JSON.parse(json), r("AgentPeerMessage"));
    }

    public static agentPeerMessageToJson(value: AgentPeerMessage): string {
        return JSON.stringify(uncast(value, r("AgentPeerMessage")), null, 2);
    }
    ...
    public static toGardenReview(json: string): GardenReview {
        return cast(JSON.parse(json), r("GardenReview"));
    }

    public static gardenReviewToJson(value: GardenReview): string {
        return JSON.stringify(uncast(value, r("GardenReview")), null, 2);
    }

    public static toGardenReviewEvidence(json: string): GardenReviewEvidence {
        return cast(JSON.parse(json), r("GardenReviewEvidence"));
    }

    public static gardenReviewEvidenceToJson(value: GardenReviewEvidence): string {
        return JSON.stringify(uncast(value, r("GardenReviewEvidence")), null, 2);
    }

    public static toGardenReviewItem(json: string): GardenReviewItem {
        return cast(JSON.parse(json), r("GardenReviewItem"));
    }

    public static gardenReviewItemToJson(value: GardenReviewItem): string {
        return JSON.stringify(uncast(value, r("GardenReviewItem")), null, 2);
    }

    public static toGardenReviewRecipe(json: string): GardenReviewRecipe {
        return cast(JSON.parse(json), r("GardenReviewRecipe"));
    }

    public static gardenReviewRecipeToJson(value: GardenReviewRecipe): string {
        return JSON.stringify(uncast(value, r("GardenReviewRecipe")), null, 2);
    }

    public static toGardenReviewRun(json: string): GardenReviewRun {
        return cast(JSON.parse(json), r("GardenReviewRun"));
    }

    public static gardenReviewRunToJson(value: GardenReviewRun): string {
        return JSON.stringify(uncast(value, r("GardenReviewRun")), null, 2);
    }

    public static toGardenReviewUpdatedMessage(json: string): GardenReviewUpdatedMessage {
        return cast(JSON.parse(json), r("GardenReviewUpdatedMessage"));
    }

    public static gardenReviewUpdatedMessageToJson(value: GardenReviewUpdatedMessage): string {
        return JSON.stringify(uncast(value, r("GardenReviewUpdatedMessage")), null, 2);
    }
    ...
    public static toPullRequestCreatedMessage(json: string): PullRequestCreatedMessage {
        return cast(JSON.parse(json), r("PullRequestCreatedMessage"));
    }

    public static pullRequestCreatedMessageToJson(value: PullRequestCreatedMessage): string {
        return JSON.stringify(uncast(value, r("PullRequestCreatedMessage")), null, 2);
    }

    public static toPullRequestForgetMessage(json: string): PullRequestForgetMessage {
        return cast(JSON.parse(json), r("PullRequestForgetMessage"));
    }

    public static pullRequestForgetMessageToJson(value: PullRequestForgetMessage): string {
        return JSON.stringify(uncast(value, r("PullRequestForgetMessage")), null, 2);
    }
    ...
    public static toSeedHarvestCondition(json: string): SeedHarvestCondition {
        return cast(JSON.parse(json), r("SeedHarvestCondition"));
    }

    public static seedHarvestConditionToJson(value: SeedHarvestCondition): string {
        return JSON.stringify(uncast(value, r("SeedHarvestCondition")), null, 2);
    }

    public static toSeedHarvestWhenMerged(json: string): SeedHarvestWhenMerged {
        return cast(JSON.parse(json), r("SeedHarvestWhenMerged"));
    }

    public static seedHarvestWhenMergedToJson(value: SeedHarvestWhenMerged): string {
        return JSON.stringify(uncast(value, r("SeedHarvestWhenMerged")), null, 2);
    }
    ...
    public static toSeedReviewActionContext(json: string): SeedReviewActionContext {
        return cast(JSON.parse(json), r("SeedReviewActionContext"));
    }

    public static seedReviewActionContextToJson(value: SeedReviewActionContext): string {
        return JSON.stringify(uncast(value, r("SeedReviewActionContext")), null, 2);
    }

    public static toSeedReviewCancelMessage(json: string): SeedReviewCancelMessage {
        return cast(JSON.parse(json), r("SeedReviewCancelMessage"));
    }

    public static seedReviewCancelMessageToJson(value: SeedReviewCancelMessage): string {
        return JSON.stringify(uncast(value, r("SeedReviewCancelMessage")), null, 2);
    }

    public static toSeedReviewDraftMessage(json: string): SeedReviewDraftMessage {
        return cast(JSON.parse(json), r("SeedReviewDraftMessage"));
    }

    public static seedReviewDraftMessageToJson(value: SeedReviewDraftMessage): string {
        return JSON.stringify(uncast(value, r("SeedReviewDraftMessage")), null, 2);
    }

    public static toSeedReviewDraftResultMessage(json: string): SeedReviewDraftResultMessage {
        return cast(JSON.parse(json), r("SeedReviewDraftResultMessage"));
    }

    public static seedReviewDraftResultMessageToJson(value: SeedReviewDraftResultMessage): string {
        return JSON.stringify(uncast(value, r("SeedReviewDraftResultMessage")), null, 2);
    }

    public static toSeedReviewKeepMessage(json: string): SeedReviewKeepMessage {
        return cast(JSON.parse(json), r("SeedReviewKeepMessage"));
    }

    public static seedReviewKeepMessageToJson(value: SeedReviewKeepMessage): string {
        return JSON.stringify(uncast(value, r("SeedReviewKeepMessage")), null, 2);
    }

    public static toSeedReviewResult(json: string): SeedReviewResult {
        return cast(JSON.parse(json), r("SeedReviewResult"));
    }

    public static seedReviewResultToJson(value: SeedReviewResult): string {
        return JSON.stringify(uncast(value, r("SeedReviewResult")), null, 2);
    }

    public static toSeedReviewResultMessage(json: string): SeedReviewResultMessage {
        return cast(JSON.parse(json), r("SeedReviewResultMessage"));
    }

    public static seedReviewResultMessageToJson(value: SeedReviewResultMessage): string {
        return JSON.stringify(uncast(value, r("SeedReviewResultMessage")), null, 2);
    }

    public static toSeedReviewRetryMessage(json: string): SeedReviewRetryMessage {
        return cast(JSON.parse(json), r("SeedReviewRetryMessage"));
    }

    public static seedReviewRetryMessageToJson(value: SeedReviewRetryMessage): string {
        return JSON.stringify(uncast(value, r("SeedReviewRetryMessage")), null, 2);
    }

    public static toSeedReviewShowMessage(json: string): SeedReviewShowMessage {
        return cast(JSON.parse(json), r("SeedReviewShowMessage"));
    }

    public static seedReviewShowMessageToJson(value: SeedReviewShowMessage): string {
        return JSON.stringify(uncast(value, r("SeedReviewShowMessage")), null, 2);
    }

    public static toSeedReviewStartMessage(json: string): SeedReviewStartMessage {
        return cast(JSON.parse(json), r("SeedReviewStartMessage"));
    }

    public static seedReviewStartMessageToJson(value: SeedReviewStartMessage): string {
        return JSON.stringify(uncast(value, r("SeedReviewStartMessage")), null, 2);
    }

    public static toSeedSendToChiefMessage(json: string): SeedSendToChiefMessage {
        return cast(JSON.parse(json), r("SeedSendToChiefMessage"));
    }

    public static seedSendToChiefMessageToJson(value: SeedSendToChiefMessage): string {
        return JSON.stringify(uncast(value, r("SeedSendToChiefMessage")), null, 2);
    }

    public static toSeedSendToChiefResult(json: string): SeedSendToChiefResult {
        return cast(JSON.parse(json), r("SeedSendToChiefResult"));
    }

    public static seedSendToChiefResultToJson(value: SeedSendToChiefResult): string {
        return JSON.stringify(uncast(value, r("SeedSendToChiefResult")), null, 2);
    }

    public static toSeedSendToChiefResultMessage(json: string): SeedSendToChiefResultMessage {
        return cast(JSON.parse(json), r("SeedSendToChiefResultMessage"));
    }

    public static seedSendToChiefResultMessageToJson(value: SeedSendToChiefResultMessage): string {
    ...
    public static toSessionClosedMessage(json: string): SessionClosedMessage {
        return cast(JSON.parse(json), r("SessionClosedMessage"));
    }

    public static sessionClosedMessageToJson(value: SessionClosedMessage): string {
        return JSON.stringify(uncast(value, r("SessionClosedMessage")), null, 2);
    }
    ...
    public static toSessionLedgerEntry(json: string): SessionLedgerEntry {
        return cast(JSON.parse(json), r("SessionLedgerEntry"));
    }

    public static sessionLedgerEntryToJson(value: SessionLedgerEntry): string {
        return JSON.stringify(uncast(value, r("SessionLedgerEntry")), null, 2);
    }

    public static toSessionLedgerFacet(json: string): SessionLedgerFacet {
        return cast(JSON.parse(json), r("SessionLedgerFacet"));
    }

    public static sessionLedgerFacetToJson(value: SessionLedgerFacet): string {
        return JSON.stringify(uncast(value, r("SessionLedgerFacet")), null, 2);
    }

    public static toSessionLedgerFacets(json: string): SessionLedgerFacets {
        return cast(JSON.parse(json), r("SessionLedgerFacets"));
    }

    public static sessionLedgerFacetsToJson(value: SessionLedgerFacets): string {
    ...
    public static sessionListMessageToJson(value: SessionListMessage): string {
        return JSON.stringify(uncast(value, r("SessionListMessage")), null, 2);
    }

    public static toSessionListResult(json: string): SessionListResult {
        return cast(JSON.parse(json), r("SessionListResult"));
    }

    public static sessionListResultToJson(value: SessionListResult): string {
        return JSON.stringify(uncast(value, r("SessionListResult")), null, 2);
    }

    public static toSessionListResultMessage(json: string): SessionListResultMessage {
        return cast(JSON.parse(json), r("SessionListResultMessage"));
    }

    public static sessionListResultMessageToJson(value: SessionListResultMessage): string {
        return JSON.stringify(uncast(value, r("SessionListResultMessage")), null, 2);
    }
    ...
    public static sessionPullRequestToJson(value: SessionPullRequest): string {
        return JSON.stringify(uncast(value, r("SessionPullRequest")), null, 2);
    }
    ...
    public static toSessionShowMessage(json: string): SessionShowMessage {
        return cast(JSON.parse(json), r("SessionShowMessage"));
    }

    public static sessionShowMessageToJson(value: SessionShowMessage): string {
    ...
    public static sessionShowResultToJson(value: SessionShowResult): string {
        return JSON.stringify(uncast(value, r("SessionShowResult")), null, 2);
    }

    public static toSessionShowResultMessage(json: string): SessionShowResultMessage {
        return cast(JSON.parse(json), r("SessionShowResultMessage"));
    }

    public static sessionShowResultMessageToJson(value: SessionShowResultMessage): string {
        return JSON.stringify(uncast(value, r("SessionShowResultMessage")), null, 2);
    }
    ...
    public static toSessionUsage(json: string): SessionUsage {
        return cast(JSON.parse(json), r("SessionUsage"));
    }

    public static sessionUsageToJson(value: SessionUsage): string {
        return JSON.stringify(uncast(value, r("SessionUsage")), null, 2);
    }

    public static toSessionUsageModel(json: string): SessionUsageModel {
        return cast(JSON.parse(json), r("SessionUsageModel"));
    }

    public static sessionUsageModelToJson(value: SessionUsageModel): string {
        return JSON.stringify(uncast(value, r("SessionUsageModel")), null, 2);
    }
    ...
    public static toStopBackgroundTask(json: string): StopBackgroundTask {
        return cast(JSON.parse(json), r("StopBackgroundTask"));
    }

    public static stopBackgroundTaskToJson(value: StopBackgroundTask): string {
        return JSON.stringify(uncast(value, r("StopBackgroundTask")), null, 2);
    }
...
const typeMap: any = {
    ...
    "AgentInboxMessage": o([
        { json: "cmd", js: "cmd", typ: r("AgentInboxMessageCmd") },
        { json: "limit", js: "limit", typ: u(undefined, 0) },
        { json: "message_id", js: "message_id", typ: u(undefined, "") },
        { json: "recipient_session_id", js: "recipient_session_id", typ: "" },
    ], "any"),
    "AgentMsgMessage": o([
    ...
    "AgentPeekResult": o([
        ...
        { json: "exit", js: "exit", typ: u(undefined, r("Exit")) },
        { json: "label", js: "label", typ: "" },
    ...
    "PullRequestElement": o([
        ...
        { json: "state", js: "state", typ: "" },
        { json: "status_fetched_at", js: "status_fetched_at", typ: u(undefined, "") },
        { json: "title", js: "title", typ: u(undefined, "") },
        { json: "url", js: "url", typ: "" },
    ], "any"),
    "Usage": o([
    ...
    "ModelObject": o([
        ...
        { json: "cache_write_unclassified_tokens", js: "cache_write_unclassified_tokens", typ: 0 },
        { json: "cost_usd", js: "cost_usd", typ: u(undefined, 3.14) },
        { json: "has_unpriced_usage", js: "has_unpriced_usage", typ: true },
    ...
    "ItemObject": o([
        ...
        { json: "advisor_attempt", js: "advisor_attempt", typ: u(undefined, 0) },
        { json: "advisor_error", js: "advisor_error", typ: u(undefined, "") },
        { json: "advisor_max_attempts", js: "advisor_max_attempts", typ: u(undefined, 0) },
        { json: "advisor_retry_at", js: "advisor_retry_at", typ: u(undefined, "") },
        { json: "advisor_state", js: "advisor_state", typ: u(undefined, "") },
        { json: "advisor_updated_at", js: "advisor_updated_at", typ: u(undefined, "") },
        { json: "body", js: "body", typ: "" },
        { json: "cited_evidence", js: "cited_evidence", typ: u(undefined, a("")) },
        ...
        { json: "resolved_action", js: "resolved_action", typ: u(undefined, "") },
        { json: "review_again_at", js: "review_again_at", typ: u(undefined, "") },
        { json: "run_id", js: "run_id", typ: "" },
        { json: "seed_id", js: "seed_id", typ: "" },
        { json: "seed_rev", js: "seed_rev", typ: 0 },
        { json: "started_at", js: "started_at", typ: u(undefined, "") },
        { json: "status", js: "status", typ: "" },
        { json: "title", js: "title", typ: "" },
    ], "any"),
    ...
    "GardenReviewUpdatedMessage": o([
        { json: "event", js: "event", typ: r("GardenReviewUpdatedMessageEvent") },
        { json: "review", js: "review", typ: r("GardenReviewUpdatedMessageReview") },
    ], "any"),
    ...
    "PullRequestForgetMessage": o([
        { json: "cmd", js: "cmd", typ: r("PullRequestForgetMessageCmd") },
        { json: "id", js: "id", typ: "" },
        { json: "url", js: "url", typ: "" },
    ], "any"),
    ...
    "Response": o([
        ...
        { json: "agent_inbox_batch_result", js: "agent_inbox_batch_result", typ: u(undefined, r("AgentInboxBatchResultObject")) },
        { json: "agent_inbox_result", js: "agent_inbox_result", typ: u(undefined, r("Agent")) },
        { json: "agent_msg_result", js: "agent_msg_result", typ: u(undefined, r("AgentMsgResultObject")) },
        { json: "agent_msg_status_result", js: "agent_msg_status_result", typ: u(undefined, r("Agent")) },
        ...
        { json: "session_list_result", js: "session_list_result", typ: u(undefined, r("SessionListResultObject")) },
    ...
    "SessionInstructionsResultObject": o([
        ...
        { json: "evidence", js: "evidence", typ: a(r("EvidenceObject")) },
        { json: "model", js: "model", typ: "" },
    ...
    "SessionListResultObject": o([
        { json: "entries", js: "entries", typ: a(r("Entry")) },
        { json: "facets", js: "facets", typ: u(undefined, r("Facets")) },
        { json: "next_before", js: "next_before", typ: u(undefined, "") },
    ...
    "SeedHarvestWhenMerged": o([
        { json: "pull_request_url", js: "pull_request_url", typ: u(undefined, "") },
    ], "any"),
    "SeedLinkMessage": o([
    ...
    "SeedReviewDraftResultMessage": o([
        { json: "error", js: "error", typ: u(undefined, "") },
        { json: "event", js: "event", typ: r("SeedReviewDraftResultMessageEvent") },
        { json: "handoff", js: "handoff", typ: u(undefined, "") },
        { json: "request_id", js: "request_id", typ: "" },
        { json: "success", js: "success", typ: true },
    ], "any"),
    ...
    "SeedSendToChiefResultMessage": o([
        { json: "error", js: "error", typ: u(undefined, "") },
        { json: "event", js: "event", typ: r("SeedSendToChiefResultMessageEvent") },
        { json: "request_id", js: "request_id", typ: "" },
    ...
    "SeedTransitionMessage": o([
        ...
        { json: "when_merged", js: "when_merged", typ: u(undefined, r("WhenMerged")) },
    ], "any"),
    "WhenMerged": o([
        { json: "pull_request_url", js: "pull_request_url", typ: u(undefined, "") },
    ], "any"),
    ...
    "SessionListResultMessage": o([
        { json: "error", js: "error", typ: u(undefined, "") },
        { json: "event", js: "event", typ: r("SessionListResultMessageEvent") },
        { json: "request_id", js: "request_id", typ: "" },
        { json: "result", js: "result", typ: u(undefined, r("SessionListResultObject")) },
        { json: "success", js: "success", typ: true },
    ], "any"),
    "SessionMessage": o([
        { json: "key", js: "key", typ: "" },
    ...
    "SessionShowResultMessage": o([
        { json: "entry", js: "entry", typ: u(undefined, r("Entry")) },
        { json: "error", js: "error", typ: u(undefined, "") },
        { json: "event", js: "event", typ: r("SessionShowResultMessageEvent") },
        { json: "request_id", js: "request_id", typ: "" },
        { json: "success", js: "success", typ: true },
    ], "any"),
    ...
    "StopBackgroundTask": o([
        { json: "name", js: "name", typ: u(undefined, "") },
        { json: "status", js: "status", typ: "" },
        { json: "type", js: "type", typ: "" },
    ], "any"),
    "StopMessage": o([
        { json: "background_tasks", js: "background_tasks", typ: u(undefined, a(r("BackgroundTaskElement"))) },
        { json: "cmd", js: "cmd", typ: r("StopMessageCmd") },
        { json: "id", js: "id", typ: "" },
        { json: "pending_session_crons", js: "pending_session_crons", typ: u(undefined, 0) },
        { json: "transcript_path", js: "transcript_path", typ: "" },
    ], "any"),
    "BackgroundTaskElement": o([
        { json: "name", js: "name", typ: u(undefined, "") },
        { json: "status", js: "status", typ: "" },
        { json: "type", js: "type", typ: "" },
    ], "any"),
    ...
    "WebSocketEvent": o([
        ...
        { json: "session", js: "session", typ: u(undefined, r("SessionObject")) },
        { json: "session_id", js: "session_id", typ: u(undefined, "") },
        { json: "session_ledger_entry", js: "session_ledger_entry", typ: u(undefined, r("Entry")) },
        { json: "sessions", js: "sessions", typ: u(undefined, a(r("SessionObject"))) },
        { json: "settings", js: "settings", typ: u(undefined, m("")) },
        { json: "signal", js: "signal", typ: u(undefined, "") },
    ...
    "GardenReviewUpdatedMessageEvent": [
        "garden_review_updated",
    ],
    ...
    "PullRequestCreatedMessageCmd": [
        "pull_request_created",
    ],
    "PullRequestForgetMessageCmd": [
        "pull_request_forget",
    ],
    ...
    "SeedReviewCancelMessageCmd": [
        "seed_review_cancel",
    ],
    "SeedReviewDraftMessageCmd": [
        "seed_review_draft",
    ],
    "SeedReviewDraftResultMessageEvent": [
        "seed_review_draft_result",
    ],
    "SeedReviewKeepMessageCmd": [
        "seed_review_keep",
    ],
    "SeedReviewResultMessageEvent": [
        "seed_review_result",
    ],
    "SeedReviewRetryMessageCmd": [
        "seed_review_retry",
    ],
    "SeedReviewShowMessageCmd": [
        "seed_review_show",
    ],
    "SeedReviewStartMessageCmd": [
        "seed_review_start",
    ],
    "SeedSendToChiefMessageCmd": [
        "seed_send_to_chief",
    ],
    ...
    "SessionListMessageCmd": [
        "session_list",
    ],
    "SessionListResultMessageEvent": [
        "session_list_result",
    ],
