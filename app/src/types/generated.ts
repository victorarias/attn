...
//   const getTourEventMessage = Convert.toGetTourEventMessage(json);
...
export interface GetTourEventMessage {
    cmd:      GetTourEventMessageCmd;
    event_id: string;
    tour_id:  string;
    [property: string]: any;
}

export enum GetTourEventMessageCmd {
    GetTourEvent = "get_tour_event",
}
...
export class Convert {
    ...
    public static toGetTourEventMessage(json: string): GetTourEventMessage {
        return cast(JSON.parse(json), r("GetTourEventMessage"));
    }

    public static getTourEventMessageToJson(value: GetTourEventMessage): string {
        return JSON.stringify(uncast(value, r("GetTourEventMessage")), null, 2);
    }
...
const typeMap: any = {
    ...
    "GetTourEventMessage": o([
        { json: "cmd", js: "cmd", typ: r("GetTourEventMessageCmd") },
