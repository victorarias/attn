...
//   const agentCloseRule = Convert.toAgentCloseRule(json);
...
export enum AgentCloseMessageCmd {
...
export interface AgentCloseResultObject {
    label:             string;
    reason:            string;
    rule:              AgentCloseRule;
    seed_ids:          string[];
...
export class Convert {
    ...
    public static toAgentCloseMessage(json: string): AgentCloseMessage {
        return cast(JSON.parse(json), r("AgentCloseMessage"));
    }

    public static agentCloseMessageToJson(value: AgentCloseMessage): string {
        return JSON.stringify(uncast(value, r("AgentCloseMessage")), null, 2);
    }

    public static toAgentCloseResult(json: string): AgentCloseResult {
        return cast(JSON.parse(json), r("AgentCloseResult"));
    }

    public static agentCloseResultToJson(value: AgentCloseResult): string {
        return JSON.stringify(uncast(value, r("AgentCloseResult")), null, 2);
    }

    public static toAgentCloseRule(json: string): AgentCloseRule {
        return cast(JSON.parse(json), r("AgentCloseRule"));
    }

    public static agentCloseRuleToJson(value: AgentCloseRule): string {
        return JSON.stringify(uncast(value, r("AgentCloseRule")), null, 2);
    }
...
const typeMap: any = {
    ...
    "AgentCloseResult": o([
        { json: "label", js: "label", typ: "" },
        { json: "reason", js: "reason", typ: "" },
        { json: "rule", js: "rule", typ: r("AgentCloseRule") },
        { json: "seed_ids", js: "seed_ids", typ: a("") },
        { json: "target_session_id", js: "target_session_id", typ: "" },
    ], "any"),
    "AgentEventMessage": o([
    ...
    "Response": o([
        ...
        { json: "agent_close_result", js: "agent_close_result", typ: u(undefined, r("AgentCloseResultObject")) },
