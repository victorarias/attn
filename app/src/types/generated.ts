...
//   const ptyOutputACKMessage = Convert.toPtyOutputACKMessage(json);
...
export interface PtyOutputACKMessage {
    cmd: PtyOutputACKMessageCmd;
    id:  string;
    seq: number;
    [property: string]: any;
}

export enum PtyOutputACKMessageCmd {
    PtyOutputACK = "pty_output_ack",
}
...
export interface WorkspaceActionResultMessage {
    action:     string;
    error?:     string;
    event:      WorkspaceActionResultMessageEvent;
    pane_id?:   string;
    session_id: string;
    success:    boolean;
    [property: string]: any;
...
export enum WorkspaceActionResultMessageEvent {
    WorkspaceActionResult = "workspace_action_result",
}
...
export class Convert {
    ...
    public static toPtyOutputACKMessage(json: string): PtyOutputACKMessage {
        return cast(JSON.parse(json), r("PtyOutputACKMessage"));
    }

    public static ptyOutputACKMessageToJson(value: PtyOutputACKMessage): string {
        return JSON.stringify(uncast(value, r("PtyOutputACKMessage")), null, 2);
    }
    ...
    public static toWorkspaceActionResultMessage(json: string): WorkspaceActionResultMessage {
        return cast(JSON.parse(json), r("WorkspaceActionResultMessage"));
    }

    public static workspaceActionResultMessageToJson(value: WorkspaceActionResultMessage): string {
        return JSON.stringify(uncast(value, r("WorkspaceActionResultMessage")), null, 2);
    }
...
const typeMap: any = {
    ...
    "PtyOutputACKMessage": o([
        { json: "cmd", js: "cmd", typ: r("PtyOutputACKMessageCmd") },
        { json: "id", js: "id", typ: "" },
    ...
    "WorkspaceActionResultMessage": o([
        { json: "action", js: "action", typ: "" },
        { json: "error", js: "error", typ: u(undefined, "") },
        { json: "event", js: "event", typ: r("WorkspaceActionResultMessageEvent") },
        { json: "pane_id", js: "pane_id", typ: u(undefined, "") },
        { json: "session_id", js: "session_id", typ: "" },
        { json: "success", js: "success", typ: true },
    ], "any"),
