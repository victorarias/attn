...
//   const cancelAutoSettleMessage = Convert.toCancelAutoSettleMessage(json);
...
export interface CancelAutoSettleMessage {
    cmd:        CancelAutoSettleMessageCmd;
    session_id: string;
    [property: string]: any;
}

export enum CancelAutoSettleMessageCmd {
    CancelAutoSettle = "cancel_auto_settle",
}
...
export class Convert {
    ...
    public static toCancelAutoSettleMessage(json: string): CancelAutoSettleMessage {
        return cast(JSON.parse(json), r("CancelAutoSettleMessage"));
    }

    public static cancelAutoSettleMessageToJson(value: CancelAutoSettleMessage): string {
        return JSON.stringify(uncast(value, r("CancelAutoSettleMessage")), null, 2);
    }
...
const typeMap: any = {
    ...
    "CancelAutoSettleMessage": o([
        { json: "cmd", js: "cmd", typ: r("CancelAutoSettleMessageCmd") },
