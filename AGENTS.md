...
- **Clean up the profile you created.** Nothing reaps it for you: its daemon
  ...
  days later. `attn profile clean <name>` reaps the workers and conversation
  hosts, stops the daemon, quits the app, and removes the bundle and data dir. `make install
