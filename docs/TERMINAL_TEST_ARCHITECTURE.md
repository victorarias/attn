...
- `TR-201` local Claude via `scenario-tr201-local-relaunch-existing-split.mjs`
- `TR-204` local Claude via `scenario-tr204-local-relaunch-formatting.mjs`
- `TR-301` local Claude via `scenario-tr301-local-utility-session-switch.mjs`
- `TR-401` local Claude via `scenario-tr401-local-window-resize.mjs`
