...
- [ ] **NEW — bound the frontend streaming WASM-heap balloon** (250→1148 MB retained; biggest measured memory effect). Frontend; root-cause first.
- [ ] **fe-term-2 — shrink 2048² atlas** (GPU 181 MB) + confirm WS-1 win via warm-set A/B. Frontend.
