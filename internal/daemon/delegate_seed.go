...
func (d *Daemon) bindDelegationSeed(sessionID, plannerSessionID, brief, name, crown string) (string, error) {
	seedID, err := d.bindDelegatedSeed(sessionID, plannerSessionID, brief, name, crown)
	switch {
	case err == nil:
...
func (d *Daemon) bindDelegatedSeed(sessionID, plannerSessionID, brief, name, crown string) (string, error) {
	...
	if err := d.recordGardenDispatch(sessionID, seedID); err != nil {
