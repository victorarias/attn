...
var CommandMeta = map[string]CommandMetadata{
	...
	protocol.CmdSeedSendToChief:            commandMetadata(ScopeHubLocal, false, true),
	protocol.CmdSeedReviewStart:            commandMetadata(ScopeHubLocal, false, true),
	protocol.CmdSeedReviewShow:             commandMetadata(ScopeHubLocal, false, true),
	protocol.CmdSeedReviewCancel:           commandMetadata(ScopeHubLocal, false, true),
	protocol.CmdSeedReviewRetry:            commandMetadata(ScopeHubLocal, false, true),
	protocol.CmdSeedReviewKeep:             commandMetadata(ScopeHubLocal, false, true),
	protocol.CmdSeedReviewDraft:            commandMetadata(ScopeHubLocal, false, true),
	...
	// The registry, the pin and the sweep log are this daemon's own state; the
	// hub aggregating outpost registries is s-pmzxay, not here.
	protocol.CmdWorktreeList:                          commandMetadata(ScopeHubLocal, false, true),
	protocol.CmdWorktreeKeep:                          commandMetadata(ScopeHubLocal, false, true),
	protocol.CmdWorktreeSweepLog:                      commandMetadata(ScopeHubLocal, false, true),
	protocol.CmdWorktreeRefresh:                       commandMetadata(ScopeHubLocal, false, true),
	...
	// Blocks during recovery, unlike its get/save/clear siblings: it types into a PTY.
	...
	protocol.CmdAutoModeEnvSlot:          commandMetadata(ScopeHubLocal, false, true),
	protocol.CmdAutoModeEnvNotes:         commandMetadata(ScopeHubLocal, false, true),
