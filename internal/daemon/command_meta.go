...
var CommandMeta = map[string]CommandMetadata{
	...
	protocol.CmdDeleteBranch:             commandMetadata(ScopeEndpoint, false, true),
	protocol.CmdSwitchBranch:             commandMetadata(ScopeEndpoint, false, true),
	protocol.CmdCreateWorktreeFromBranch: commandMetadata(ScopeEndpoint, false, true),
	protocol.CmdCreateBranch:             commandMetadata(ScopeEndpoint, false, true),
	protocol.CmdCheckDirty:               commandMetadata(ScopeEndpoint, false, true),
	protocol.CmdStash:                    commandMetadata(ScopeEndpoint, false, true),
	protocol.CmdStashPop:                 commandMetadata(ScopeEndpoint, false, true),
	protocol.CmdCheckAttnStash:           commandMetadata(ScopeEndpoint, false, true),
	protocol.CmdCommitWIP:                commandMetadata(ScopeEndpoint, false, true),
	...
	protocol.CmdSpawnSession:             commandMetadata(ScopeSession, true, true),
	...
	protocol.CmdWorkspaceGet:             commandMetadata(ScopeSession, true, true),
	protocol.CmdWorkspaceSplitPane:       commandMetadata(ScopeSession, true, true),
	protocol.CmdWorkspaceClosePane:       commandMetadata(ScopeSession, true, true),
	protocol.CmdWorkspaceFocusPane:       commandMetadata(ScopeSession, true, true),
	protocol.CmdWorkspaceRenamePane:      commandMetadata(ScopeSession, true, true),
}
