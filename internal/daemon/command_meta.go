...
var CommandMeta = map[string]CommandMetadata{
	...
	protocol.CmdHookNotification:           commandMetadata(ScopeSession, false, true),
	protocol.CmdHookStopFailure:            commandMetadata(ScopeSession, false, true),
	protocol.CmdHookCompaction:             commandMetadata(ScopeSession, false, true),
	...
	// so logging it would bury daemon.log in lines nobody reads. `attn activity`
	// is how you see the tier it adds up to instead.
	protocol.CmdSetClientPresence:        commandMetadata(ScopeHubLocal, false, false),
	protocol.CmdActivityStatus:           commandMetadata(ScopeHubLocal, false, true),
	protocol.CmdClearSessionActivity:     commandMetadata(ScopeHubLocal, false, true),
	...
	// Unlogged: scrolling back through a conversation is reading, and a long
	...
	protocol.CmdOpenSeed:                              commandMetadata(ScopeHubLocal, false, true),
	protocol.CmdOpenSentFiles:                         commandMetadata(ScopeSession, true, true),
	protocol.CmdSeedDocumentGet:                       commandMetadata(ScopeHubLocal, false, true),
