...
## Plant the work you discover

Planting is an ordinary move, taken without being asked. Fix what you found when it is
...
and wither generously: `attn seed wither` closes what nobody should pick up.

Before a session reports done, note what was learned, harvest what is finished,
and park or hand off what is not.
