...
- **You can now split a session into its own workspace by dragging it out.** Start dragging a session pane and a "New workspace" drop zone appears at the foot of the sidebar — drop the session there and attn moves it into a brand-new workspace at the end of your list. If the move empties the workspace it came from, that empty one is cleaned up for you.
